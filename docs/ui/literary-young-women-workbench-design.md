...
- 产品名称：`图像手记 / Visual Journal`
- 产品副标题：`今天想做什么画面？`
- 核心定位：面向中文小红书和电商内容运营者的 AI 图像创作工作台，服务首版封面、商品氛围图和活动视觉稿。
...
目标用户是中文小红书和电商内容运营者；年轻女性、独立杂志读者、摄影和设计爱好者只用于视觉气质校准，不作为第一真实用户证明。
...
生成动作区必须贴近模型、路由、请求方式和请求数量，避免用户点按钮前不清楚本次请求的配置与范围。
