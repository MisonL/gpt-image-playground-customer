...
**Files:**
- Modify: `README.md`
- Modify: `skills/visual-journal-image-agent/SKILL.md`
- Modify: `skills/visual-journal-image-agent/references/api.md`
- Modify: `docs/product/product-contract.md`
...
```bash
git add README.md docs/product/product-contract.md skills/visual-journal-image-agent/SKILL.md skills/visual-journal-image-agent/references/api.md
