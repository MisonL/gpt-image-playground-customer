...
const messages: Record<Locale, Record<string, string>> = {
    'zh-CN': {
        ...
        'ux.disabledSourceImage': '请先选择要编辑的源图片。',
        ...
        'output.emptyTitle': '等待生成结果',
        'output.emptyDescription': '提交后这里会显示实时预览、最终图片和可发送到编辑的操作。',
        'output.error': '图片显示失败。',
    ...
    'en-US': {
        ...
        'ux.disabledSourceImage': 'Select a source image before editing.',
        ...
        'output.emptyTitle': 'Waiting for output',
        'output.emptyDescription': 'Submit a request to see live previews, final images, and send-to-edit actions here.',
        ...
        'error.adviceAuth': 'Check the API Key, page password, or channel permissions.',
