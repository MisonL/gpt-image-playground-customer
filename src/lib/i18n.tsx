...
const messages: Record<Locale, Record<string, string>> = {
    'zh-CN': {
        ...
        'history.statusEmpty': '生成后会在这里显示真实进度摘要。',
        'history.mobileHint': '移动端：画布优先，底部抽屉',
    ...
    'en-US': {
        ...
        'history.statusEmpty': 'Real generation summaries will appear here.',
        'history.mobileHint': 'Mobile: canvas first, bottom drawer',
