...
const messages: Record<Locale, Record<string, string>> = {
    'zh-CN': {
        ...
        'history.statusStart': '开始生成',
        'history.statusDeveloping': '正在显影 62%',
        'history.statusDone': '生成完成',
        'history.statusEstimate': '预计完成时间 8-12 秒',
        'history.statusFailed': '生成失败，模型超时，请重试',
    ...
    'en-US': {
        ...
        'history.statusStart': 'Started generation',
        'history.statusDeveloping': 'Developing 62%',
        'history.statusDone': 'Generated',
        'history.statusEstimate': 'Estimated completion in 8-12s',
        'history.statusFailed': 'Generation failed. Model timed out. Retry.',
